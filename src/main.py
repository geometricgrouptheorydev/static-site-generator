...
#generates a single html page from markdown
...
#generates every page in a directory
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path, basepath):
    ...
    for item in content:
        ...
        if os.path.isfile(item_path) and item.endswith(".md"):
            generate_page(item_path, template_path, dest_path + f"/{item[:-3]}.html", basepath) #we replace .md with .html
